...
def read_from_file():
    global words_bank
    f=open("D:\python\Python\Assignment_8/translate.txt","r")
    temp=f.read().split("\n")
    words_bank=[]
...
def write_to_file():
    f=open("D:\python\Python\Assignment_8/translate.txt","w")
...
def persian_to_english():
    ...
    voice.save("D:\python\Python\Assignment_8/voice.mp3")
    print(out_put)
